...
{
    public class FlashCard2ViewModel
    {
        ...
        public FlashCard2ViewModel(ISettingService settingService, INavigationService navigationService)
        {
            ...
            NextCommand.Subscribe(async _ => await Next());
        }
